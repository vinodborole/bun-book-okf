...
To use Bun’s S3 client with
[Google Cloud Storage](https://cloud.google.com/storage), set
...
To use Bun’s S3 client with
[Cloudflare R2](https://developers.cloudflare.com/r2/), set
...
To use Bun’s S3 client with
[DigitalOcean Spaces](https://www.digitalocean.com/products/spaces/), set
...
To use Bun’s S3 client with
[Supabase](https://supabase.com/), set
