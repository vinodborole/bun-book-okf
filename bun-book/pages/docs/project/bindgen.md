...
There are other code generators and systems that achieve similar purposes; the following will all eventually be phased out in favor of this one:
...
```
Depending on the type, more attributes are available. See the type definitions in auto-complete for details. You can apply only one of these three attributes, and you must apply it last.
